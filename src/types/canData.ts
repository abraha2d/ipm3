...
export let canData: CANData = {
  ...
  lights: {
    ...
    fogLeft: LightState.ON,
    fogRight: LightState.ON,
    highBeamLeft: LightState.ON,
    highBeamRight: LightState.ON,
    indicatorLeftRequest: LightRequest.OFF,
    indicatorRightRequest: LightRequest.OFF,
    lowBeamLeft: LightState.ON,
    lowBeamRight: LightState.ON,
    parkLeft: LightState.ON,
    parkRight: LightState.ON,
